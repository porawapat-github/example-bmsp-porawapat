    ...
    return (
        <div className="overflow-x-hidden">
            <header className="text-slate-700 relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 lg:mx-auto lg:flex-row lg:items-center">
                <a href="#" className="flex items-center whitespace-nowrap text-2xl font-black">
                    <span className="mr-2 w-8">
                        <img src="https://media.tenor.com/BTABuyIjDbQAAAAi/dragon-yawn.gif" alt="Logo" />
                    </span>
                    Profile
                </a>
            ...
            <div className="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-transparent -translate-y-15">
                    <div className="mx-auto max-w-3xl text-center">
                        <h1 className="mt-5 text-3xl font-light leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
                            ...
                            <span className="relative inline-flex justify-center whitespace-nowrap font-bold">
                                <svg className="absolute -bottom-8 hidden w-2/3 text-gray-400 sm:block" viewBox="0 0 490 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="fixed bottom-0 left-0 w-full bg-white z-50 flex flex-col items-center justify-center divide-y divide-gray-300 sm:flex-row sm:divide-x sm:divide-y-0 mb-5    ">
